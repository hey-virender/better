...
const Start = () => {
  return (
    <main className="pt-6 md:px-20">
      <nav>
        <header className="flex justify-between">
          <div>
            <a href="#">
              <svg
                class="icon icon-logo-mortgage"
                height="100%"
                role="img"
                version="1.1"
                viewBox="0 0 62 31"
          ...
          <div>
            <button>
              <div className="flex gap-2 items-center">
                ...
                <h5 class="text-sm">Need help? Call (415) 523 8837</h5>
              </div>
            </button>
          </div>
        </header>
        <div className="relative flex justify-center items-center">
          <div className="absolute bg-[#e8eae6] h-1 w-3/4"></div>
          <div className="h-12 w-12 overflow-hidden rounded-full z-10">
            <img
      ...
      <div className="mt-10">
        <div>
          <h1 className="text-center text-[#292b29] font-semibold lg:text-3xl">
          ...
          <div className="flex justify-center mt-4">
            <div className="flex flex-col gap-5 text-xs font-bold">
              <button className="flex h-10 w-80 justify-start rounded-md  items-center gap-5 border-[0.01vw] border-black  pl-10 py-1 transition-all ease-in-out duration-200 hover:border-4 hover:border-[#3e9873] hover:text-[#3e9873] lg:w-96 lg:text-lg lg:h-16 lg:font-medium">
                <div>
                  <svg
                    fill="transparent"
                    height="25"
          ...
          <div className="flex gap-10 mt-12 justify-center font-light">
            <div className="text-center text-xs lg:text-lg">
              <p className="text-xl font-medium mb-4">$100B</p>
              <p>home loans funded entirely online</p>
            </div>
            <div className="text-center text-xs lg:text-lg">
              <p className="text-xl font-medium mb-4">400K</p>
              <p>Customers who chose a Better Mortgage</p>
            </div>
          </div>
          <div className="flex flex-col items-center text-md font-normal mt-16 bg-[#f0f7f1] w-3/4 py-7 mx-auto text-textSecondary">
